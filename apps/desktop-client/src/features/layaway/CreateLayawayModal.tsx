                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-600 dark:text-slate-400 mt-1">
                            Stock: {product.stock_quantity || 0} • {formatMoney(product.sale_price)}
                          </div>
                        </div>
            ...
            <div className="max-w-md mx-auto space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-slate-900/50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white">{formatMoney(calculateSubtotal())}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-slate-400">Tax (20%)</span>
                    <span className="text-gray-900 dark:text-white">{formatMoney(calculateTax())}</span>
                  </div>
                  <div className="flex justify-between pt-2 border-t border-gray-200 dark:border-slate-700 font-medium">
                    <span className="text-gray-900 dark:text-white">Total</span>
                    <span className="text-gray-900 dark:text-white">{formatMoney(calculateTotal())}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-slate-400 mt-2">
                  Deposit Amount: <span className="font-medium">{formatMoney(depositAmount)}</span>
                </p>
                <p className="text-sm text-amber-600 dark:text-amber-400 mt-1">
                  Balance Due: <span className="font-medium">{formatMoney(calculateTotal() - depositAmount)}</span>
                </p>
              </div>
